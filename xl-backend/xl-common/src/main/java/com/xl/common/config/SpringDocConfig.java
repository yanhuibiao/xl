...
public class SpringDocConfig {
    ...
    public OpenAPI springDocOpenAPI() {
        return new OpenAPI().openapi("3.1.0").info(new Info().title("Xl API")
                .description("Xl接口文档说明").version("1.0.0")
                .license(new License().name("xl Code repository").url("https://gitee.com/yanhuibiao/xl")))
                .externalDocs(new ExternalDocumentation().description("xl Wiki")
