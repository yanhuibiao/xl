-- 创建订单数据库
CREATE DATABASE IF NOT EXISTS xl_order_0 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
CREATE DATABASE IF NOT EXISTS xl_order_1 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- 使用订单数据库
USE xl_order_0;
